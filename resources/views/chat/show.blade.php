    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-slate-200 dark:bg-red-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-decoration-black dark:text-red-100 ">
          ...
          <!-- Inicia mensaje izquierda -->
            <div class="clearfix">
              <div class="bg-sky-200 w-3/4 mx-4 my-2 p-2 rounded-lg">this is a basic mobile chat layout, build with tailwind css</div>
            </div>
          <!-- Termina mensaje izquierda -->
          <!-- Inicia mensaje derecha -->
          <div class="clearfix">
            <div class="bg-sky-400 float-right w-3/4 mx-4 my-2 p-2 rounded-lg">check my twitter to see when it will be released.</div>
          </div>
          <!-- Termina mensaje de la derecha -->
          <!-- Inicia textarea para enviar mensajes -->
          <div class="w-full flex justify-center" style="bottom: 0px;">
            <textarea 
              class="flex-grow m-2 py-4 px-3 mr-1 rounded-lg border border-gray-200 bg-black-200 resize-none" rows="1" placeholder="Message..." style="outline: none;">
            </textarea>
